...
int main(int argc, char* argv[])
{

  {
    ...
    // participation index
    real_type_2d_view_type Beta("Beta", n_variables, n_processes);
    index_csplib::evalBeta(member, B, S, Beta);
    ...
    std::vector< double > RoPv (RoP.extent(0),0);
    Tines::convertToStdVector(RoPv, RoP);
