...
int main(int argc, char *argv[]) {
  ...
  //cstr inputs
  std::string inputFile(prefixPath + "PRFSolution.dat");
...

  {
    ...
    ChemElemDAE_PFR_TChem  model(chemFile, chemSurfFile,
    ...
    // set parameter for PFR
    model.setPlugFlowReactor(Area, Pcat);
